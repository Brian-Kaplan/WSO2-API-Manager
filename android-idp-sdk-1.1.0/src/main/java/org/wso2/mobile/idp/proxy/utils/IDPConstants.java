...
public class IDPConstants {
    public final static String IDP_PROXY_PACKAGE = "com.example.shobal.myapplication";
    public final static String IDP_PROXY_ACTIVITY = "com.example.shobal.myapplication.WebViewActivity";
    public final static String CALL_BACK_URL = "http://google.com";
